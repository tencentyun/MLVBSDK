...
#import "Replaykit2ViewController.h"
...
@interface Replaykit2ViewController () <AddressBarControllerDelegate, ScanQRDelegate>
...
@implementation Replaykit2ViewController {
...
- (void)addressBarControllerTapCreateURL:(AddressBarController *)controller
{
    ...
    __weak Replaykit2ViewController* weakSelf = self;
...
//    }
    ...
    if (!transString)
        return;
    pb.string = transString;
    CFNotificationCenterPostNotification(CFNotificationCenterGetDarwinNotifyCenter(),kDarvinNotificaiotnNameRotationChange,NULL,nil,YES);
