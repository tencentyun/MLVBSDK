...
class TRTCAvatarListCell: UICollectionViewCell {
    ...
    override func draw(_ rect: CGRect) {
        super.draw(rect)
        headImageView.layer.cornerRadius = frame.height / 3
        selectView.layer.cornerRadius = selectView.frame.height / 3
        selectView.layer.borderWidth = 3
        selectView.layer.borderColor = UIColor.init("006EFF").cgColor
    }
...
fileprivate extension String {
    static let confirmText = LoginLocalize("Demo.TRTC.Login.done")
    static let setAvatarText = LoginLocalize("Demo.TRTC.Login.setavatar")
}
