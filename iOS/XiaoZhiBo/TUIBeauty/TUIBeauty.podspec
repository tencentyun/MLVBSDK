Pod::Spec.new do |spec|
  ...
  spec.subspec 'Live' do |live|
    ...
    live.source_files = 'Source/Localized/**/*.{h,m,mm}', 'Source/PublicHeader/*', 'Source/Model/**/*.{h,m,mm,c}', 'Source/Server/**/*.{h,m,mm}', 'Source/UI/**/*.{h,m,mm}', 'Source/TUIExtension/**/*.{h,m,mm}', 'Source/Common/**/*.{h,m,mm}', 'Source/Presenter/**/*.{h,m,mm}', 'Source/TUIBeautyKit_Live/*.{h,m,mm}'
  ...
  spec.subspec 'Professional' do |professional|
    ...
    professional.source_files = 'Source/Localized/**/*.{h,m,mm}', 'Source/PublicHeader/*', 'Source/Model/**/*.{h,m,mm,c}', 'Source/Server/**/*.{h,m,mm}', 'Source/UI/**/*.{h,m,mm}', 'Source/TUIExtension/**/*.{h,m,mm}', 'Source/Common/**/*.{h,m,mm}', 'Source/Presenter/**/*.{h,m,mm}', 'Source/TUIBeautyKit_Professional/*.{h,m,mm}'
