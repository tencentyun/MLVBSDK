...
- (void)login {
    ...
    [httpSession GET:strCgiUrl parameters:nil headers:nil progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        [weakManager invalidateSessionCancelingTasks:NO resetSession:NO];
