...
public class LivePushScreenEnterActivity extends MLVBBaseActivity {
    ...
    private void initView(){
        ...
        str.setSpan(new URLSpan("https://cloud.tencent.com/document/product/454/56595"),text.indexOf("https://"),text.indexOf("56595") + 5, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
    ...
    private void startPushCamera(int type) {
        ...
        if(TextUtils.isEmpty(streamId)){
            Toast.makeText(LivePushScreenEnterActivity.this,getString(R.string.livepushscreen_please_input_streamid), Toast.LENGTH_SHORT).show();
        }else{
