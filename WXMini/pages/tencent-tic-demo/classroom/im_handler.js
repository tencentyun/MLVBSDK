...
IMHandler.prototype = {
   ...
   * @param {Function} fail 
   */
  loginIm(loginData, success, fail) {
    if (!webim.checkLogin()) {
   ...
   * @param {*} fail 失败回调
   */
  joinChatGroup(groupId, succ, fail) {
    var self = this;
    this.selSess = null;
   ...
   * @param {*} fail 失败回调
   */
  joinBoardGroup(groupId, succ, fail) {
    var self = this;
    this.selSess = null;
    webim.applyJoinGroup({
        GroupId: String(groupId)
   ...
   * @param {function} fail
   */
  sendGroupTextMsg(msg, groupId, succ, fail) {
   ...
   * @param {function} fail
   */
  sendGroupCustomMsg(msgObj, groupId, succ, fail) {
    this.groupData['groupId'] = groupId;
