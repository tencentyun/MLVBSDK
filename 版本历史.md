...
1. iOS修复onNetStatus回调NET_SPEED不准的问题。
2. iOS修复TXVideoEditer按时间点获取缩略图偶现返回数据不正确问题。
3. iOS修复设置动效切后台后无效的问题。
4. Android企业版新增64位支持，P图库支持动态下载。
5. Android短视频修复编辑视频页Crash。
...
【其他】
- iOS&Android：商业版支持 licence 设置接口，在线下载更新 licence。
...
【短视频】
- iOS&Android：短视频增加多个版本：精简版，基础版，商业版，商业版 Pro，以满足不同客户的需求，不同版本需申请对应的 licence。
